...
public class Ordenamientos {
    ...
    public static void burbuja(ArrayList<Persona> lista) {
        int n = lista.size();
        for (int i = 0; i < n - 1; i++) {
    ...
    public static void seleccion(ArrayList<Persona> lista) {
        int n = lista.size();
        for (int i = 0; i < n - 1; i++) {
            int minIdx = i;
            for (int j = i + 1; j < n; j++) {
    ...
    public static void insercion(ArrayList<Persona> lista) {
    ...
    public static void shell(ArrayList<Persona> lista) {
        int n = lista.size();
    ...
    private static void mergeSort(ArrayList<Persona> lista, int left, int right) {
        if (left < right) {
    ...
    private static void merge(ArrayList<Persona> lista, int left, int mid, int right) {
        int n1 = mid - left + 1;
        int n2 = right - mid;
    ...
    public static void quickSort(ArrayList<Persona> lista) {
        quickSort(lista, 0, lista.size() - 1);
    }
    
    private static void quickSort(ArrayList<Persona> lista, int low, int high) {
        if (low < high) {
    ...
    private static int particion(ArrayList<Persona> lista, int low, int high) {
